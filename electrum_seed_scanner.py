...
"""
TODO: โปรแกรมนี้ใช้ทรัพยากรเครื่องเยอะมาก CPU วิ่ง 100% ทุกเธรด!!! และใช้ RAM เฉลี่ย 16GB บางทีขึ้นสูงสุดถึง19GB!!!
 ...
 เราต้องไปติดตั้งและกำหนดค่า RPC ให้เสร็จก่อนนะครับ
"""
